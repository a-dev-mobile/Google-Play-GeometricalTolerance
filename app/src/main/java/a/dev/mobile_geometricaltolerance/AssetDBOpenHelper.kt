...
class AssetDBOpenHelper(private val context: Context) : SQLiteOpenHelper(
    ...
    companion object {
        ...
        const val DB_NAME = "geometricaltolerance.db"
        /********************************/
        const val DB_TABLE_DOPUSK = "dopusk"
    ...
    fun getDataDB(type: Int): ArrayList<BaseModel> {
        ...
        val selectQuery = "select * from $DB_TABLE_DOPUSK where $COLUMN_TYPE = $type"
        val cursor: Cursor?
            ...
            while (!cursor.isAfterLast) {
                ...
                modelData.add(
                    BaseModel(
                        ...
                        cursor.getString(cursor.getColumnIndex(COLUMN_INFO)),
